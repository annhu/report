...
count = 0
res = requests.get('http://www.ipeen.com.tw/search/all/000/4-7-16-0/?p=1&adkw=%E5%8F%B0%E5%8D%97&baragain=1')
...
#抓取每一頁的連結
    ...
    page_format = "http://www.ipeen.com.tw/search/all/000/4-7-16-0/?p=%d"
