...
#count = 0
res = requests.get('http://www.ipeen.com.tw/search/all/000/4-7-14-0/?p=1&adkw=%E5%8F%B0%E5%8D%97&baragain=1')
...
#抓取每一頁的連結
    ...
    page_format = "http://www.ipeen.com.tw/search/all/000/4-7-14-0/?p=%d"
        ...
        for i in shop1:
            ...
            if shop2_open.text.encode('utf8') != "【已歇業】":
                if shop2_open.text.encode('utf8') != "【已搬遷】":
                    print shop2.text.encode('utf-8').strip().split('(')[0]
